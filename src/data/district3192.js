...
export const ZONES = [
  { id: 'A', name: 'Zone A', ambassador: 'Shankar Sastry C V', secretary: 'Arjun E Merwade', geography: 'Central Bengaluru' },
  { id: 'B', name: 'Zone B', ambassador: 'Sharavana J', secretary: 'Narendran V B', geography: 'East/North-East Bengaluru' },
  { id: 'C', name: 'Zone C', ambassador: 'Aravind S Hooli', secretary: 'Paul Mundackal', geography: 'North Bengaluru, Chikballapur, Devanahalli' },
  { id: 'D', name: 'Zone D', ambassador: 'Manjunath Patil K', secretary: 'Pratap Ujjini', geography: 'West/North-West Bengaluru, Nelamangala' },
  { id: 'E', name: 'Zone E', ambassador: 'Madhusudan R Bidi', secretary: 'Naagheash S', geography: 'North-West Bengaluru, Peenya corridor' },
  { id: 'F', name: 'Zone F', ambassador: 'Prasanna Kumar C N', secretary: 'Srinivasa Murthy M G', geography: 'Tumkur district' },
  { id: 'G', name: 'Zone G', ambassador: 'Rajesh T S', secretary: 'Bernadappa I', geography: 'Mandya district' },
];

export const CLUBS = [
  // ─── ZONE A ───
  { id: '15766', name: 'Bangalore', zone: 'A', ag: 'Fazal Ur Rahaman', president: 'Sukhen Padmanabha', charterDate: '12-Jul-1934',
  ...
  { id: '51651', name: 'Bangalore Brigades', zone: 'A', ag: 'Anil Rikke', president: 'Mrs. Mahadevi Dayananda Biradar', charterDate: '06-Jan-1999',
    ...
    sponsored: { newRotaryClubs: [], newRotaractClubs: ['Acharya Bangalore B School'], newInteractClubs: [], sponsoredRCC: [] },
    serviceProjects: { projects: 76, volunteers: 208, manHours: 2031, cost: 121863 } },

  { id: '88092', name: 'Bangalore Centennial', zone: 'A', ag: 'Fazal Ur Rahaman', president: 'Rtr Srinivas Prabhu', charterDate: '24-Nov-2016',
  ...
  { id: '24067', name: 'Bangalore Central', zone: 'A', ag: 'Anil Rikke', president: 'Chandrashekhar SM', charterDate: '30-Sep-1986',
  ...
  { id: '84647', name: 'Bangalore Gokul Vidya', zone: 'A', ag: 'Anil Rikke', president: 'Mr. Sunder Murthy Lakkaiyan', charterDate: '26-Jun-2012',
  ...
  { id: '223008', name: 'Bangalore Gulmohar', zone: 'A', ag: 'Fazal Ur Rahaman', president: 'Mrs. Sudha Rani Raavi', charterDate: '02-Jul-2021',
  ...
  { id: '82899', name: 'Bangalore Junction', zone: 'A', ag: 'Ashok B Patil', president: 'Kamal Kishore Karnani', charterDate: '05-Feb-2010',
  ...
  { id: '26816', name: 'Bangalore R.T. Nagar', zone: 'A', ag: 'Sidharth Hamirwasia', president: 'Mrs Sarita H Desai', charterDate: '01-Dec-1989',
  ...
  { id: '31297', name: 'Bangalore Rajmahal Vilas', zone: 'A', ag: 'Sidharth Hamirwasia', president: 'Rajagopal Hegde', charterDate: '12-Feb-1996',
  ...
  { id: '80571', name: 'Bangalore Sadashivanagar', zone: 'A', ag: 'Sidharth Hamirwasia', president: 'Pranam K J', charterDate: '15-Oct-2008',
    ...
    sponsored: { newRotaryClubs: ['Bengaluru Namma Samskriti', 'Praani Mitra'], newRotaractClubs: [], newInteractClubs: [], sponsoredRCC: [] },
    serviceProjects: { projects: 4, volunteers: 13, manHours: 27, cost: 6100 } },

  { id: '222188', name: 'E-Club of Bengaluru Sakhi', zone: 'A', ag: 'Ashok B Patil', president: 'Prathima Narasapur Rajarao', charterDate: '19-Jan-2021',
  ...
  // ─── ZONE B ───
  { id: '226024', name: 'Bangalore DownTowners', zone: 'B', ag: 'Nalini Nanjundayya', president: 'Mr Baburajan Angadiyil', charterDate: '18-Apr-2024', isNew: true,
  ...
  { id: '15768', name: 'Bangalore Indiranagar', zone: 'B', ag: 'Nalini Nanjundayya', president: 'Vipin Labroo', charterDate: '11-Jun-1981',
  ...
  { id: '65720', name: 'Bangalore Kalyan', zone: 'B', ag: 'Nalini Nanjundayya', president: 'Jyothi Manjunath', charterDate: '09-Jun-2004',
  ...
  { id: '79294', name: 'Bangalore Ramamurthy Nagar', zone: 'B', ag: 'Usha Prasad', president: 'AshokRaju G', charterDate: '28-May-2008',
  ...
  { id: '50540', name: 'Bangalore Ulsoor', zone: 'B', ag: 'Usha Prasad', president: 'Rtn. Vijayakumar P', charterDate: '11-Jun-1997',
  ...
  { id: '227165', name: 'Bengaluru Arunodaya', zone: 'B', ag: 'Kiran S Rtr.', president: 'Ganganna M.', charterDate: '01-Aug-2025', isNew: true,
  ...
  { id: '91002', name: 'Bengaluru Disha', zone: 'B', ag: 'Usha Prasad', president: 'Naresh Bhandia', charterDate: '02-Jun-2020',
  ...
  { id: '91121', name: 'Bengaluru Lake World', zone: 'B', ag: 'Mohan Kumar', president: 'Mr. Vivian John Thenguvila', charterDate: '24-Jun-2020',
  ...
  { id: '87667', name: 'Bengaluru Manyata', zone: 'B', ag: 'Mohan Kumar', president: 'Dr Manjunath M T', charterDate: '10-Jun-2016',
  ...
  { id: '227001', name: 'Bengaluru Namma Samskriti', zone: 'B', ag: 'Kiran S Rtr.', president: 'Mr. Lakshmi Narayanan S.', charterDate: '19-Jun-2025', isNew: true,
  ...
  { id: '226388', name: 'Bengaluru Zionhills', zone: 'B', ag: 'Mohan Kumar', president: 'Arun Acharya', charterDate: '22-Aug-2024', isNew: true,
  ...
  { id: '88562', name: 'Bangalore Vidyaranyapura', zone: 'C', ag: 'Harish A P', president: 'Sreekanthan N', charterDate: '09-Jun-2017',
  ...
  { id: '65579', name: 'Bangalore Yelahanka', zone: 'C', ag: 'Prashanth Babu S J', president: 'Mr ASHOK HEBBAR', charterDate: '02-Jun-2004',
  ...
  { id: '90313', name: 'Bangalore Oasis', zone: 'C', ag: 'Vinod Kumar V S', president: 'Partha Sarathi Kommineni', charterDate: '24-Jun-2019',
  ...
  { id: '87115', name: 'Bengaluru Heritage North', zone: 'C', ag: 'Aparna Kanampalli', president: 'Mr Arun Tanksali', charterDate: '08-Oct-2015',
  ...
  { id: '76592', name: 'Bangalore Sahakaranagar', zone: 'C', ag: 'Prashanth Babu S J', president: 'Ravindra Guntamadugu', charterDate: '27-Jun-2007',
  ...
  { id: '225976', name: 'Bangalore Skyway', zone: 'C', ag: 'Srinivas Manjappa Kanagod', president: 'Bhavna Choudhary', charterDate: '20-Mar-2024', isNew: true,
  ...
  // ─── ZONE D (key clubs) ───
  { id: '53592', name: 'Bangalore Udyog', zone: 'D', ag: 'Rupashree Venkat', president: 'Mr. Sandeep G Parvatikar', charterDate: '17-May-2000',
    ...
    sponsored: { newRotaryClubs: [], newRotaractClubs: ['Christ University Bangalore Yeshwanthpur Campus', 'Dhanwantri Institutions'], newInteractClubs: [], sponsoredRCC: [] },
    serviceProjects: { projects: 15, volunteers: 86, manHours: 928, cost: 9709 } },

  { id: '86539', name: 'Bengaluru Platinum City', zone: 'D', ag: 'Naveen Kumar M T', president: 'SANDHYA RAGHUNANDAN', charterDate: '20-Mar-2015',
    ...
    sponsored: { newRotaryClubs: [], newRotaractClubs: ['Bengaluru Compassion Crew'], newInteractClubs: ['East West Public School', 'Jasa Horizons', 'St. John High School'], sponsoredRCC: [] },
    serviceProjects: { projects: 165, volunteers: 646, manHours: 4169, cost: 17436 } },

  { id: '79057', name: 'Nelamangala', zone: 'D', ag: 'Surendra Rao D', president: 'Nagaraju G R', charterDate: '07-May-2008',
    ...
    sponsored: { newRotaryClubs: ['Bengaluru Arunodaya'], newRotaractClubs: [], newInteractClubs: [], sponsoredRCC: [] },
    serviceProjects: { projects: 120, volunteers: 2267, manHours: 10980, cost: 48280 } },

  // ─── ZONE E (key clubs) ───
  { id: '15772', name: 'Bangalore Peenya', zone: 'E', ag: 'Suryaprakash V Rathnam', president: 'Meenakshi Sarath', charterDate: '25-Apr-1983',
  ...
  { id: '15771', name: 'Bangalore North', zone: 'E', ag: 'Ashwath Narayan K S', president: 'S.K. Manjunath', charterDate: '09-May-1966',
  ...
  { id: '15775', name: 'Bangalore West', zone: 'E', ag: 'Shivananda Gowdanavara Srinivasiah', president: 'YOGESH PACHISIA', charterDate: '18-May-1977',
  ...
  // ─── ZONE F (key clubs) ───
  { id: '15819', name: 'Tumkur', zone: 'F', ag: 'Krishnaprasad R', president: 'Dr. Ambaram Sundaram Sudarshan', charterDate: '03-Dec-1957',
  ...
  { id: '61999', name: 'Tumkur Central', zone: 'F', ag: 'Krishnaprasad R', president: 'Ramasheshagiri Rao A', charterDate: '01-May-2003',
  ...
  // ─── ZONE G (key clubs) ───
  { id: '15804', name: 'Mandya', zone: 'G', ag: 'Chandresh A R', president: 'Rajashekara. C', charterDate: '01-Mar-1954',
  ...
  { id: '87428', name: 'Sakkare Naadu Mandya', zone: 'G', ag: 'Aksharam Venkatesh', president: 'Nandish M', charterDate: '06-Apr-2016',
